    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-hidden select-none">
      ...
      >
        <div className="bg-[#FAF6EE] border border-[#E3D7C7] rounded-3xl p-6 sm:p-10 shadow-[0_12px_40px_rgba(70,45,30,0.1)] text-center">
          {/* Subtle celestial seal emblem */}
          <div className="relative mb-5 inline-flex flex-col items-center justify-center">
            <div className="relative w-16 h-16 rounded-full bg-[#050811] border border-[#E5B85A]/40 shadow-[0_4px_16px_rgba(5,8,17,0.2)] overflow-hidden flex items-center justify-center">
              <img
              ...
              />
              <div
                className="absolute -inset-1 rounded-full border border-dashed border-[#D5C2B0]/40 pointer-events-none"
                aria-hidden="true"
              />
            </div>
            <span className="mt-2 text-[10px] uppercase tracking-[0.2em] font-serif text-[#A08878] select-none">
              Private Sanctuary
            </span>
          </div>

          {/* Title */}
          <h1 className="text-2xl sm:text-3xl font-serif font-normal italic text-[#382B22] tracking-tight mb-1">
            Gaalimaatalu
          </h1>
          <p className="text-xs uppercase tracking-[0.22em] font-mono text-[#8C6B5E] font-medium mb-3">
            Starlit Letters
          </p>
