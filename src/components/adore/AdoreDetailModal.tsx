      ...
      >
          ...
          <button
            ...
            className={cn(
              ...
              isLetterArchive
                ...
                : isScrapbook
                ? 'text-[#6D655B] hover:text-[#4A4038] hover:bg-[#E5D1B0]/60 focus-visible:ring-[#788C6B]'
            ...
            <button
              ...
              className={cn(
                ...
                isLetterArchive
                  ...
                  : isScrapbook
                  ? 'text-[#8C8376] hover:text-[#4A4038] hover:bg-[#E5D1B0]/60 focus-visible:ring-[#788C6B]'
            ...
            <div
              className={cn(
                ...
                isLetterArchive
                  ...
                  : isScrapbook
                  ? 'p-2 bg-[#FAF1DF] border border-[rgba(120,140,107,0.3)]'
                  : 'p-2 bg-[#142238] border border-[#344761]'
              )}
            >
              <CrossFadeImage
                src={item.image}
        ...
        <div className="relative z-10 pt-5 pb-3 space-y-3">
              ...
              <span
                className={cn(
                  ...
                  isLetterArchive
                    ...
                    : isScrapbook
                    ? 'bg-[#788C6B]/15 text-[#788C6B] border border-[rgba(120,140,107,0.35)]'
                    : 'bg-[#18273B] text-[#D6B56C] border border-[#344761]'
                )}
              >
                ...
                <span
                  className={cn(
                    ...
                    isLetterArchive
                      ...
                      : isScrapbook
                      ? 'bg-[#FAF1DF] text-[#6D655B] border-[rgba(120,140,107,0.3)]'
          ...
          <h2
            ...
            className={cn(
              'text-2xl sm:text-3xl font-serif font-semibold tracking-tight leading-snug pt-1',
              isLetterArchive
                ? 'text-[#3B2A20]'
                : isScrapbook
                ? 'text-[#4A4038]'
          ...
          <div
            className={cn(
              ...
              isLetterArchive
                ...
                : 'bg-[#142238] border-[#344761] text-[#9EADC2]'
            )}
          >
